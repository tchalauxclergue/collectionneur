...
# knitr::knit_engines$set('latin1')

devtools::build_rmd(files = "C:/Users/chalauth/ChalauxThomas/Code/R/collectionneur/README.Rmd") 
```
...
- Supports any database format and customisation settings for handling missing values.
...
If you encounter a clear bug, have a question or suggestion, please either open an [Issues](https://github.com/tchalauxclergue/collectionneur/issues) or send an email to [Thomas Chalaux-Clergue (thomaschalaux@icloud.com)](mailto:thomaschalaux@icloud.com).
